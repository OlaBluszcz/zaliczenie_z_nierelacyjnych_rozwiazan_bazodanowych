...
// Wyswietlanie zajec bez szkol, opinii i trenerow.

exports.classes_get_all = async (req, res) => {
    try {
        const classes = await Class.aggregate([
            { $project: { name: 1, level: 1, price: 1, date: 1, time: 1 } } // Wybor interesujacych nas pol.
        ]);
...
exports.classes_add_review = async (req, res) => {
    ...
    try {
        // Dodawanie nowej recenzji do tablicy `reviews`
...
// Wyświetlanie konkretnych zajec tylko z opiniami.
...
// Wyswietlanie konkretnych zajec ze szkola, opinia i trenerami.
